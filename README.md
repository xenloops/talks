...
This talk explores the real (and fixable) reasons behind that friction, and how it cripples our response to modern threats. We’ll look at how AppSec programs unintentionally sabotage themselves through poor communication, tooling overload, and unrealistic policies. We’ll discuss practical ways to rebuild trust and agility, and touch on how unresolved friction compounds actual business risk, and how to frame risk in terms that resonate with engineering leadership.

Whether you’re a developer tired of security theater or an AppSec lead wondering why your risk assessments are rushed through at 3x speed, you’ll leave with strategies that make your AppSec program as adaptable as the threats it’s meant to defend against. And maybe even prevent the Vogons from demolishing your secure SDLC for a hyperspace bypass.
...
[Slides](https://github.com/xenloops/talk-dogfood-pipeline-cd/blob/main/start_here.md)
